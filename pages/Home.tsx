    ...
    <div className="flex flex-col">
      ...
      <div className="relative h-[80vh] w-full overflow-hidden">
        ...
        <div className="relative h-full flex flex-col items-center justify-center text-center px-4 max-w-4xl mx-auto">
          ...
          <p className="text-lg md:text-xl text-gray-100 mb-8 max-w-2xl drop-shadow-md">
            A sanctuary for organic farming, holistic education, and the pursuit of harmonious co-existence in Nargol.
          </p>
      ...
      <section className="py-16 md:py-24 px-4 bg-sand-beige">
        <div className="max-w-3xl mx-auto text-center">
          <span className="text-soil-brown font-bold tracking-wider uppercase text-sm mb-2 block">Welcome</span>
          <h2 className="font-serif text-3xl md:text-4xl font-bold text-gray-900 mb-6">
            A Community Rooted in Nature
          </h2>
          <p className="text-gray-600 text-lg leading-relaxed mb-8">
            Jeevan Utsav Kendra is an NGO initiative located in the serene surroundings of Nargol, near Vapi. 
            We are dedicated to exploring and living the principles of Jeevan Vidya. Through our residential school, 
            organic farming practices, and skill development centers, we strive to build a community that lives in 
